...
SIDIK_ADMIN_TOKEN_VALIDATION_ENDPOINT = os.environ.get('SIDIK_ADMIN_TOKEN_VALIDATION_ENDPOINT', '')
...
RUMAHIOT_LEMARI_USER_DASHBOARD_CHARTS_COLLECTION = os.environ.get('RUMAHIOT_LEMARI_USER_DASHBOARD_CHARTS_COLLECTION', '')
