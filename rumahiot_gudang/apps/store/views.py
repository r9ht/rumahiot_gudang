...
from rumahiot_gudang.apps.store.utils import RequestUtils,ResponseGenerator
                ...
                if device_data != None:
                    ...
                    for data in d.sensor_datas:
                        try:
                            ...
                            if type(s.device_sensor_uuid) is str and type(s.device_sensor_value) is float:
                    ...
                    device_data['device_sensors'].sort()
                    sensor_list.sort()
                    # Match the data from user_device collection with the one from the request
                    if device_data['device_sensors'] == sensor_list:
                        try:
