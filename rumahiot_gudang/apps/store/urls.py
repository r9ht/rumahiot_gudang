...
from rumahiot_gudang.apps.store.views import store_device_data, store_new_device, \
    store_generated_device_xlsx_data,store_new_supported_sensor, store_new_supported_board
...
urlpatterns = [
    ...
    url(r'^board/supported/new$', store_new_supported_board, name='store_new_supported_board'),
